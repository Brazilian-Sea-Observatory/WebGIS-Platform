...
The purpose of this client is to provide a description of the products of an SOS server and allow user to subset and download data.
...
If you do not provide this configuration file, you will have to specify configuration items directly in command line arguments. 
Please also be aware that any command line given option will OVERWRITE options in configuration file.
