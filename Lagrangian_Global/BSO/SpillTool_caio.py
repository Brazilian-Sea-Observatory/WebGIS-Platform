#!/usr/bin/python
import re, datetime, os, subprocess, sys, time
...
read_time = time.time()
read_input()
#Printing amount of time for read_input()
print("---read_input() took %s seconds ---" % (time.time() - read_time))

date_time = time.time()
write_date()
#Printing amount of time for write_date()
print("---write_date() took %s seconds ---" % (time.time() - date_time))

lagrangian_time = time.time()
write_lagrangian()
#Printing amount of time for write_lagrangian()
print("---write_lagrangian() %s seconds ---" % (time.time() - lagrangian_time))

mohid_time = time.time()
os.chdir(exe_dir)
print(exe_dir)
...
#Printing amount of time for Mohid Model
print("---Mohid Model took %s seconds ---" % (time.time() - mohid_time))
#Printing amount of time for Total Process
